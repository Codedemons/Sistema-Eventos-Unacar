            ...
            <div class="collapse navbar-collapse" id="navigation">
              ...
              <ul class="navbar-nav d-lg-flex d-none">
                <li class="nav-item d-flex align-items-center">
                  <a class="btn btn-outline-primary btn-sm mb-0 me-2"  href="#Eventos">Eventos</a>
                </li>
                <li class="nav-item">
                  <a href="sign-in.php" class="btn btn-sm mb-0 me-1 bg-gradient-dark">Acceder</a>
                </li>
              </ul>
            </div>
          </div>
